...
Legate has not made a stable release. Security fixes are applied to the current `main` branch only; older commits and development snapshots are not supported release lines.

## Reporting a vulnerability

Use [GitHub private vulnerability reporting](https://github.com/griwes/legate.nvim/security/advisories/new) when it is available. Do not disclose a suspected vulnerability in a public issue, discussion, or pull request.
...
See [the Legate threat model](docs/security.md) for implemented boundaries and residual risks.
