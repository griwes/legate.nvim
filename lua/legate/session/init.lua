...
---Create and select a new ACP continuity.---@param adapter_name? string
---@return legate.Session
...
---Ensure there is a current ACP continuity.---@param adapter_name? string
---@return legate.Session
...
---Return the current ACP continuity.---@return legate.Session?
function M.current()
...
---Append a transcript message to a continuity.---@param session legate.Session
...
---Store the unsent draft prompt for a continuity.---@param current_session legate.Session
---@param prompt string
...
---Record a submitted prompt on the given ACP continuity.---@param current_session legate.Session
---@param prompt string
---@return legate.Session
...
---Bind a remote ACP session id to the local continuity.---@param current_session legate.Session
---@param remote_id string?
...
---Clear the remote ACP session binding from the local continuity.---@param current_session legate.Session
---@param remote_sync_state? legate.RemoteSyncState
---@param remote_sync_error? string
...
---Store the current remote sync state on the local continuity.---@param current_session legate.Session
---@param remote_sync_state legate.RemoteSyncState
---@param remote_sync_error? string
...
---Store agent metadata on the local continuity.---@param current_session legate.Session
...
---Store session config options for the local continuity.---@param current_session legate.Session
...
---Store the current ACP plan entries on the local continuity.---@param current_session legate.Session
...
---Store the current ACP slash commands on the local continuity.---@param current_session legate.Session
