...
---@param adapters table<string, acp.AdapterConfig>
---@return string[]
...
local function normalize(opts)
    ...
    if normalized.terminal_backend ~= 'native' and normalized.terminal_backend ~= 'terminal_manager' then
